...
#include <time.h>
#include <pthread.h>
#include "multiplying_polynomials.h"
#include <stdbool.h>
...
int main( int argc, char *argv[]){
    ...
    int *P1 = (int *)malloc(size_n * sizeof(int));
    int *P2 = (int *)malloc(size_n * sizeof(int));

    int *R_serial = (int *)calloc(size_r, sizeof(int)); 
    int *R_parallel = (int *)calloc(size_r, sizeof(int));
